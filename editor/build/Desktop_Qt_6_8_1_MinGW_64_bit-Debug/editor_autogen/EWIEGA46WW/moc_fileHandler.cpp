...
static constexpr auto qt_meta_stringdata_ZN11FileHandlerE = QtMocHelpers::stringData(
    "FileHandler"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11FileHandlerE[] = {
...
Q_CONSTINIT const QMetaObject FileHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11FileHandlerE.offsetsAndSizes,
    qt_meta_data_ZN11FileHandlerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11FileHandlerE_t,
        // Q_OBJECT / Q_GADGET
...
void *FileHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11FileHandlerE.stringdata0))
